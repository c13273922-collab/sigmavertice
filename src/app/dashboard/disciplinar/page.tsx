...
export default function DisciplinarPage() {
  ...
  const badge = (s: string) => ({
    aplicada: { t: 'Aplicada', c: 'bg-red-500/15 text-red-700', i: Gavel },
    recurso: { t: 'Em recurso', c: 'bg-amber-500/15 text-amber-700', i: Clock },
    analise: { t: 'Em análise DG', c: 'bg-purple-500/15 text-purple-700', i: AlertTriangle },
    arquivado: { t: 'Arquivado', c: 'bg-slate-500/15 text-slate-700', i: FileText },
    impedimento: { t: 'Impedimento 12m', c: 'bg-red-500/25 text-red-800', i: ShieldAlert },
  }[s])
