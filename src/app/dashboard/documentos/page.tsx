...
export default function DocumentosPage() {
  ...
  const badge = (s: string) => ({
    publicado: { t: 'Publicado', c: 'bg-emerald-500/15 text-emerald-700', i: CheckCircle2 },
    revisao: { t: 'Em revisão', c: 'bg-amber-500/15 text-amber-700', i: Clock },
    analise: { t: 'Em análise', c: 'bg-blue-500/15 text-blue-700', i: Eye },
  }[s])
