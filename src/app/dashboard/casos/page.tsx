  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
        {[
          { l: 'Abertos', v: 7, c: 'text-red-700 bg-red-500/15' },
          { l: 'Em análise', v: 12, c: 'text-amber-700 bg-amber-500/15' },
          { l: 'Resolvidos', v: 38, c: 'text-emerald-700 bg-emerald-500/15' },
          { l: 'Fechados (mês)', v: 24, c: 'text-slate-700 bg-slate-500/15' },
        ].map((k, i) => (
