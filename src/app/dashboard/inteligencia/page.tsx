  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { l: 'Insights ativos', v: 38, ic: Brain, c: 'text-sigma-douradoEscuro' },
          { l: 'Fontes integradas', v: 7, ic: TrendingUp, c: 'text-sigma-azulEscuro' },
          { l: 'Confiança média', v: '91%', ic: Target, c: 'text-emerald-700' },
          { l: 'Alertas priorizados', v: 9, ic: Lightbulb, c: 'text-red-700' },
        ].map((k, i) => {
          const Ic = k.ic
          return (
