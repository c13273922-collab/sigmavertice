  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { l: 'Unidades cadastradas', v: 5, c: 'text-sigma-azul', i: Building2 },
          { l: 'Funcionários alocados', v: 232, c: 'text-sigma-douradoEscuro', i: Users },
          { l: 'Online agora', v: 4, c: 'text-emerald-700', i: Activity },
          { l: 'Municípios cobertos', v: 62, c: 'text-sigma-azulEscuro', i: MapPin },
        ].map((k, i) => {
          const Ic = k.i
          return (
            <div key={k.l} className="rounded-xl border border-sigma-azul/10 bg-white p-4 shadow-sm animate-fade-in-up" style={{ animationDelay: `${i * 0.05}s` }}>
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs uppercase tracking-wider text-sigma-azul/50 font-semibold">{k.l}</span>
